(function () {
    ...
    angular
        ...
        .factory('CuahangService', Service);
    ...
    function Service($http, $q) {
        ...
        function GetAll(_phuthuoc) {
            return $http.get('/api/cuahangs/' + _phuthuoc).then(handleSuccess, handleError);
        }
        ...
        function CreateBasicInfo(cuahang) {
            return $http.post('/api/cuahangs/createbasicinfo', cuahang).then(handleSuccess, handleError);
        }
